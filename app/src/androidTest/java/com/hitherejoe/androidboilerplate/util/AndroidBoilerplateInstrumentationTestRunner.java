...
public class AndroidBoilerplateInstrumentationTestRunner extends AndroidJUnitRunner {
    ...
    public void onStart() {
        runOnMainSync(new Runnable() {
            ...
            public void run() {
                ...
                String simpleName = AndroidBoilerplateInstrumentationTestRunner.class.getSimpleName();
